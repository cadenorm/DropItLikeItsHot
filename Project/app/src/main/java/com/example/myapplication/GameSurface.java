...
public class GameSurface extends SurfaceView implements Runnable
{
    ...
    int y = 0;
    int x = 0;
    int squareSize; //not sure what the size should shouuld be at the moment

    String helperCoordinateStr;
                    ...
                    for (int k = 0; k < coordinatesToDelete.size(); k++) {
                        ...
                        for (int j = 0; j < coords.size(); j++) {
                            ...
                            if(compareCoordString.equals(compareDeleteCoordString)) {
                                coords.remove(j); //this is probably bad practice to but fuggit
                            }
                        }
                    }
