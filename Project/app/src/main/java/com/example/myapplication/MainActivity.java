...
=======
    static int[][] gridFill = new int[7][9];
>>>>>>> 9679b2876e4d91aa75ac8bc7353441aa1db2f714
    Piece blockType;
...
=======
        timer.scheduleAtFixedRate(nextStep, 2000, 2000);
>>>>>>> 9679b2876e4d91aa75ac8bc7353441aa1db2f714
    }
...
=======
    ...
    void changeColor(int x, int y){
        ImageView imgView = (ImageView)getBlockView("b" + x + y);
        imgView.setColorFilter(Color.argb(255, 255, 0, 0));
    }
